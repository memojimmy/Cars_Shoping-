...
**model:** The BMW car model, such as 1 Series, 3 Series, 5 Series, X1, X3, and X5.

**year:** The year in which the BMW car was manufactured.

**price:** The selling price of the BMW car in British Pounds (GBP). This is the **target variable** that the Machine Learning model aims to predict.

**transmission:** The type of transmission used by the car, such as Automatic, Manual, or Semi-Auto.

**mileage:** The total distance the car has been driven, measured in miles.

**fuelType:** The type of fuel used by the car, such as Petrol, Diesel, Hybrid, or Electric.

**tax:** The annual road tax associated with the vehicle, measured in British Pounds (GBP).

**mpg:** The fuel efficiency of the car, measured in miles per gallon.

**engineSize:** The engine displacement of the car, measured in litres. For example, 1.5L, 2.0L, or 3.0L.
""")
